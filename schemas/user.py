...
class AccountLogin(BaseModel):
    username: Optional[str] = Field(min_length=3, max_length=10, description="username")
    password: Optional[str] = Field(min_length=6, max_length=12, description="password")
